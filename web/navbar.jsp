...
<aside class="sidebar-left">
    ...
    <div class="sidebar-links">
            <a class="link-green" href="controleurFrontal?action=chercherUnCours"><i class="fa fa-search"></i><div class="hidden-xs hidden-sm">Chercher un cours</div></a>
            <a class="link-green" href="controleurFrontal?action=consulterLaListeDesCours"><i class="fa fa-book"></i><div class="hidden-xs hidden-sm">Consulter la liste des cours</div></a>
